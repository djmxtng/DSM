...
<html><head>
  ...
  <!-- TeINVENTARIOowser to be responsive to screen width -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <!-- logo for regular stateINVd moble devices -->
      <span class="logo-lg"><b>INVENTARIO</span>
    </a>
    <!-- Header NavbaINVENTARIOstyle found in header.less -->
